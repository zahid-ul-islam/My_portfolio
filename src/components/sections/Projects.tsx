      ...
      >
          ...
          <div className="p-6 flex flex-col grow justify-between">
            <div>
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                {project.tech.slice(0, 4).map((tech: string, tIndex: number) => (
                  <span 
                    key={tIndex} 
            ...
            <div className="mt-auto flex items-center justify-between">
              ...
              <div className="text-accent text-sm font-medium flex items-center gap-1 group-hover:translate-x-1 transition-transform">
                {isFlipped ? "Go Back" : "Read More"} &rarr;
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="absolute inset-0 backface-hidden rotate-y-180 glass-card p-8 flex flex-col overflow-hidden border border-accent/40 bg-black/80 backdrop-blur-2xl">
          ...
          <div className="mt-auto flex items-center justify-between">
            ...
            {/* Added an explicit close/back button for mobile UX */}
            <div className="text-accent text-sm font-medium flex items-center gap-1 cursor-pointer shrink-0 ml-4 lg:hidden">
               &larr; Back
            </div>
          </div>
        </div>
